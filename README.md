About atlassian-python-api-feedstock
====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/atlassian-python-api-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/atlassian-python-api-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add atlassian-python-api
# for installing globally
pixi global install atlassian-python-api
```
...
It is possible to list all of the versions of `atlassian-python-api` available on your platform:
...
```
pixi search atlassian-python-api --channel conda-forge
```
